...
type GetSurvivorController struct {
	IGetSurvivorController
}

// Handle @Summary Get survivor
...
// @Router /survivor/{id} [get]
func (useCase GetSurvivorController) Handle(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
